This project is an exercise from Codecademy designed to test the ability to create loops that will isolate desired elements of a list and/or manipulate those lists. The code I created is included in this repo, but try to remake this code from scratch following these directions! (Note: lines 1-5 of code include information given in this assignment, necessary to complete the project).
